...
from ckanext.ytp.dataset.helpers import service_database_enabled, get_json_value, sort_datasets_by_state_priority, get_remaining_facet_item_count, \
    sort_facet_items_by_name, get_sorted_facet_items_dict, calculate_datasets_stars, get_upload_size, get_license
...
class YTPDatasetForm(plugins.SingletonPlugin, toolkit.DefaultDatasetForm):
    ...
    def get_helpers(self):
        return {'current_user': self._current_user,
                ...
                'calculate_datasets_stars': calculate_datasets_stars,
