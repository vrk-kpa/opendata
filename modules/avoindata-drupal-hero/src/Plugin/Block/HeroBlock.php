...
class HeroBlock extends BlockBase {
  ...
  public function build() {
    ...
    $form['datasetcount'] = [
      '#lazy_builder' => [\AvoindataHeroHandler::class . ':avoindata_hero_dataset_count', []],
      '#create_placeholder' => TRUE,
    ];

    $form['organizationcount'] = [
      '#lazy_builder' => [\AvoindataHeroHandler::class . ':avoindata_hero_organization_count', []],
      '#create_placeholder' => TRUE,
    ];

    $form['applicationcount'] = [
      '#lazy_builder' => [\AvoindataHeroHandler::class . ':avoindata_hero_application_count', []],
      '#create_placeholder' => TRUE,
    ];
