...
class DatasetlistBlock extends BlockBase {
  ...
  public function build() {
    ...
    $recentDatasets = [
      '#lazy_builder' => [\AvoindataDatasetHandler::class . ':avoindata_recent_datasets', []],
      '#create_placeholder' => FALSE,
    ];

    // New datasets.
    $newDatasets = [
      '#lazy_builder' => [\AvoindataDatasetHandler::class . ':avoindata_new_datasets', []],
      '#create_placeholder' => FALSE,
    ];

    // Popular datasets.
    $popularDatasets = [
      '#lazy_builder' => [\AvoindataDatasetHandler::class . ':avoindata_popular_datasets', []],
      '#create_placeholder' => FALSE,
    ];
