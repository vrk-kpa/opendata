...
/**
 * Defines the "avoindata_external-link" plugin.
 *
 ...
 *
 * @CKEditorPlugin(
 *   id = "avoindata_external-link",
 *   label = @Translation("Avoindata external link")
 * )
 */
class AvoindataExternalLinkCKEditorButton extends CKEditorPluginBase {
