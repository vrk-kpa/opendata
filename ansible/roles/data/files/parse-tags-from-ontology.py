...
the ontology library service Finto.fi. JUHO ontology is licensed under
...
if __name__ == '__main__':
    ...
    # usage: parse-tags-from-ontology.py harvest /usr/lib/ckan/default /etc/ckan/default/production.ini http://api.finto.fi/rest/v1/juho/data
