...
var assets = "modules/ytp-assets-common/";
...
var paths = {
  src: {
    ...
    ckan: assets + "src/less/ckan",
    drupal: assets + "src/less/drupal/style.less",
    drupal_ckeditor_plugins: assets + "src/less/drupal/custom-elements.less",
    templates: assets + "src/templates/**/*",
    static_pages: assets + "src/static_pages",
    fonts: assets + "src/fonts/**/*",
    ckanFontsCss: assets + "src/less/fonts-ckan.less",
    drupalFontsCss: assets + "src/less/fonts-drupal.less",
    ...
    drupal_avoindata_header: "modules/avoindata-drupal-header/resources/avoindata_header.js",
  },
  drupal_ckeditor_plugins: "modules/avoindata-drupal-ckeditor-plugins",
  drupalTheme: "modules/avoindata-drupal-theme",
...
gulp.task("clean", done => {
  del.sync([
    ...
    paths.drupalTheme + '/images',
    //paths.drupalTheme + '/templates',
    paths.drupalTheme + '/static',
    paths.drupalTheme + '/vendor',
    paths.drupalTheme + '/resource.config',
...
gulp.task("drupal_copy_custom_element_styles_to_plugin", (done) => {
  pump([
    ...
    concat("style.css"),
    sourcemaps.write("./maps"),
    gulp.dest(paths.drupal_ckeditor_plugins + "/css"),
  ], done)
});
