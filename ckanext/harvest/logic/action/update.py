...
from ckanext.harvest.queue import get_gather_publisher, resubmit_jobs, get_pending_objects
    ...
    if len(jobs):
        for job in jobs:
            if job['gather_finished']:
                ...
                pending_objects = get_pending_objects()
                if objects.count() == 0 or len(pending_objects) == 0:
